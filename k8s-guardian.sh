...
while true; do
    if check_k8s_running; then
        ...
        echo "✅ $(date): Kubernetes active - preventing sleep..." >> /Users/as/AIXTIV-SYMPHONY/logs/k8s-guardian.log
        ...
        echo "⚠️  $(date): Kubernetes not responding - allowing normal sleep" >> /Users/as/AIXTIV-SYMPHONY/logs/k8s-guardian.log
        sleep 60
    fi
done