...
class ConnectorManager {
  ...
  async processOrganizations(organizations, connectorTypes = []) {
    ...
    const types = connectorTypes.length > 0 ? connectorTypes : Object.keys(this.connectors);
    ...
    console.log(
      `✅ Completed processing ${organizations.length} organizations through ${types.length} connectors`
    );
